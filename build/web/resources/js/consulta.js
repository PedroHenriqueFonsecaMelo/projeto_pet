    ...
    if(tbody){
        ...
        if(FILTRO.trim()){
            ...
            data = data.filter( usuario => {
                return expReg.test( usuario.nome ) || expReg.test( usuario.produto )
            } )
        }
        data = data
            .sort( (a, b) => {
...
function insertUsuario(nome, produto){
...
function submeter(e){
    ...
    if(data.id){
        editUsuario(data.id, data.nome, data.produto)
    }else{
        insertUsuario( data.nome, data.produto )
    }
}
